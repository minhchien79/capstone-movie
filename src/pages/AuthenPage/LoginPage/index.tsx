...
export default function AuthenPage() {
  ...
  useEffect(() => {
    if (data1 && data1.maLoaiNguoiDung === "QuanTri") {
      navigate("/admin");
    } else if (data1) {
      navigate("/");
    }
        ...
        <div className="fixed top-0 left-0 w-full h-full flex items-center justify-center bg-gray-900 bg-opacity-50">
          <div className="bg-white p-6 rounded-md shadow-md">
            <p className="text-red-500">
              Tài khoản hoặc mật khẩu không chính xác. Vui lòng đăng nhập lại hoặc đăng ký tài khoản.
            </p>
            <div
              className="mt-4 px-4 py-2 bg-indigo-500 text-white rounded-md cursor-pointer focus:outline-none"
